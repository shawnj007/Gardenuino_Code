...
#define SYRINGE_STEPS_PER_MILLIMETER_SYRINGE ( SYRINGE_HALFSTEP_RATIO * SYRINGE_GEAR_RATIO * SYRINGE_R_H )
...
public:
	...
	PumpStepper(uint8_t type = PumpType::SYRINGE,
				float   h = 0,
				float   v = 0,
